              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  >
                    <span>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                        className="fill-black-500 md:fill-cyan-700 w-6 h-6"
                      >
                        <path
                          fill-rule="evenodd"
                ...
                <div className="relative p-6 flex-auto">
                  <p className="my-4 text-slate-500 text-lg leading-relaxed">
                    Column Chooser : drag and drop les colonnes que vous ne
                    voulez pas voir.
                  </p>
                  <p className="my-4 text-slate-500 text-lg leading-relaxed">
                    Vous pouvez changer l&apos;ordre des colonnes en faisant des
                    drag and drop.
                  </p>
                </div>
                {/*footer*/}
